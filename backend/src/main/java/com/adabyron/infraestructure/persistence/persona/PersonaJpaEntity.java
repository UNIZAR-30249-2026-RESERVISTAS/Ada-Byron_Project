...
// infraestructure/persistence/persona/PersonaJpaEntity.java
@Entity
@Table(name = "personas")
public class PersonaJpaEntity {
    ...
    public PersonaJpaEntity(UUID id, String nombre, String email, Set<Rol> roles, Integer departamentoId) {
        this.id = id;
        this.nombre = nombre;
        this.email = email;
        this.roles = roles;
